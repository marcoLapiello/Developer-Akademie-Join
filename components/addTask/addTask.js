    ...
    <div id="subtaskElementWrapper-${subtaskID}" class="subtaskElementWrapper">
      <div id="currentSubtaskBox-${subtaskID}" class="currentSubtaskBox">
        ...
        <div class="subtaskActionBox d_none">
          <div onclick="editSubtask(${subtaskID})" id="currentSubtaskEdit-${subtaskID}">Edit${returnIcon("editPen")}</div>
          <div>Divider</div>
          <div onclick="deleteSubtask('${subtaskID}', 'add')" id="currentSubtaskDelete-${subtaskID}">Delete${returnIcon("deleteTrashCan")}</div>
        </div>
      </div>
